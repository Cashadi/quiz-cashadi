...
<body>
    ...
    <!-- hero section -->
     ...
     <!-- our clients -->
     <div
      class="container mt-5 d-flex justify-content-center align-items-center flex-column clients--content"
    >
      <h2>Our Clients</h2>
    ...
    <!-- our clients -->
     ...
     <!-- manage community -->
     <div
      class="container mt-5 d-flex justify-content-center align-items-center flex-column"
    >
      <h2>Manage your entire community</h2>
      <h2>in a single system</h2>
      <p style="color: #717171">Who is Nextcent suitable for?</p>
      <div
        class="container-lg d-flex row justify-content-center align-items-center mt-2"
      >
        <!-- community 1 -->
        <div class="col-lg-4">
          <div
    ...
    <!-- manage community -->
      ...
      <div class="col-lg-7">
        <div class="d-flex flex-column justify-content-center h-100 gap-1">
          ...
          <button
            class="btn"
            style="background-color: #4caf4f; width: 150px; color: #fff"
          >
            Learn more
          </button>
        </div>
    ...
    >
      ...
      <div
        class="container-lg d-flex justify-content-center align-items-center mt-3"
      >
        <!-- image 1 -->
        <div class="col-lg-4 caring--content">
          <img src="img/caring-1.png" alt="" style="width: 90%" />
          <div
            class="d-flex flex-column justify-content-center align-items-center card--shadow--1"
          >
    ...
    <div class="content--demo">
      <div
        class="container-lg d-flex flex-column justify-content-center align-items-center gap-2"
      >
